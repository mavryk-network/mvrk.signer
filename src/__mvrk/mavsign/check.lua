local function get_devices()
	local process = proc.spawn("bin/mavsign", { "list-devices" }, {
		stdio = { stderr = "pipe" },
		wait = true,
		env = { HOME = homedir },
	...
	-- json: [{"Serial":"444F57BB6DD642A29FC6B6B0F0222117","Manufacturer":"TzC","Product":"mavsign-gadget"}]
...
local function get_wallets()
    local mavsign_configuration = am.app.get_model("MAVSIGN_CONFIGURATION", nil)
    ami_assert(mavsign_configuration,
        "Mavsign configuration not found!", EXIT_APP_INTERNAL_ERROR)
